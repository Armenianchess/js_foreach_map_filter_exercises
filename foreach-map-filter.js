...
and returns a new array with all the values in the array 
...
which accepts 
an array of strings and returns a 
new array with only
the first and last character of each string.

Examples:
    showFirstAndLast(["elie", "colt", "matt", "tim"]) // ["ee", "ct", "mt", "tm"]
...
function showFirstAndLast(arr) {
    let newArr = []
    arr.forEach(function (values) {
        newArr.push(values[0] + values[values.length - 1])
    })
    return newArr
}
...
accepts an array of objects, a key, and a 
value and returns the array passed to the 
...
Write a function called vowelCount which accepts a
 string and returns an object with the keys as the
  vowel and the values as the number of times the
   vowel appears in the string. This function should
    be case insensitive so a lowercase letter and
...
function vowelCount(str) {
    ...
    splitLetters.forEach(function (val) {
...
/*
Write a function called doubleValuesWithMap which
 accepts an array and returns a new array with all
...
function doubleValuesWithMap(arr) {
    let whatever = arr.map(function (values) {
        return values * 2
    })
    return whatever
}
...
function valTimesIndex(arr) {
    let whatever4 = arr.map(function (values, i) {
        return values * i
    })
    return whatever4
}
...
function extractKey(arr, key) {
    let whatever4 = arr.map(function (values) {
        return values[key]
    })
    return whatever4
}
...
Examples:
    extractFullName([{first: 'Elie', last:"Schoppik"},
     ...
     {first: 'Colt', last:"Steele"}]) // ['Elie Schoppik', 
     'Tim Garcia', 'Matt Lane', 'Colt Steele']
*/

function extractFullName(arr) {
    let whatever6 = arr.map(function (values) {
...
Examples:
    filterByValue([{first: 'Elie', last:"Schoppik"},
     {first: 'Tim', last:"Garcia", isCatOwner: true},
      ...
      last:"Steele", isCatOwner: true}], 'isCatOwner')
       // [{first: 'Tim', last:"Garcia", isCatOwner: true},
...
Write a function called find which
 ...
 array that has the same value as the second parameter 
...
/*
Write a function called findInObj which accepts
 an array of objects, a key, and some value to 
